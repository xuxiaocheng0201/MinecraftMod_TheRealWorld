...
public class ConfigGenerateIronMagnetite {
    private static final String category = "world_gen_iron_magnetite";

    private static final String Gen_comment = "Generate Iron Magnetite Ore?";
    ...
    public static void SetConfig(Configuration config) {
        Gen = config.get(category, "Gen", Gen, Gen_comment).getBoolean();
        chance = config.get(category, "chance", chance, chance_comment).getInt();
        maxY = config.get(category, "maxY", maxY, maxY_comment).getInt();
        minY = config.get(category, "minY", minY, minY_comment).getInt();
