...
public class IronOrePyrite extends BlockBase {
    public IronOrePyrite() {
        super("iron_ore_pyrite", Material.ROCK, CreativeTabsLoader.TheRealWorld_Ore);
        this.setHardness(6);
        this.setHarvestLevel("pickaxe", 2);
        this.setResistance(17);
