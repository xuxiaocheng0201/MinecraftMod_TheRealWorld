...
public class IronOreMagnetite extends BlockBase {
    public IronOreMagnetite() {
        super("iron_ore_magnetite", Material.ROCK, CreativeTabsLoader.TheRealWorld_Ore);
        this.setHardness(6);
    ...
    public void register_item(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("oreIronMagnetite", item);
    }
