...
public class IronOreSiderite extends BlockBase {
    public IronOreSiderite() {
        super("iron_ore_siderite", Material.ROCK, CreativeTabsLoader.TheRealWorld_Ore);
        this.setHardness(3);
    ...
    public void register_item(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("oreIronSiderite", item);
    }
