...
public class IronIngotMagnetite extends ItemBase {
    public IronIngotMagnetite() {
        super("iron_ingot_magnetite", CreativeTabsLoader.TheRealWorld_Ore);
    ...
    public void register(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("ingotIronMagnetite", this);
    }
