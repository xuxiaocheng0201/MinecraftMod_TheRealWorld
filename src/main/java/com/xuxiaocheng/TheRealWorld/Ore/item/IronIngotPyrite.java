...
public class IronIngotPyrite extends ItemBase {
    public IronIngotPyrite() {
        super("iron_ingot_pyrite", CreativeTabsLoader.TheRealWorld_Ore);
    ...
    public void register(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("ingotIronPyrite", this);
    }
