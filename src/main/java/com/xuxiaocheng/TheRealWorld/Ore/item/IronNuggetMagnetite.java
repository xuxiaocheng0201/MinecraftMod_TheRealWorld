...
public class IronNuggetMagnetite extends ItemBase {
    public IronNuggetMagnetite() {
        super("iron_nugget_magnetite", CreativeTabsLoader.TheRealWorld_Ore);
    ...
    public void register(RegistryEvent.Register<Item> event) {
        ...
        OreDictionary.registerOre("nuggetIronMagnetite", this);
    }
