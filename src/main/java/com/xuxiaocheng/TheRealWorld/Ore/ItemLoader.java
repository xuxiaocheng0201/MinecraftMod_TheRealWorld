...
public class ItemLoader {
    ...
    public static void load() {
        Log.logger(LogBase.LOGGER_LEVEL.DEBUG, "ItemLoader load starting.");
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronIngotSiderite.");
        IRON_INGOT_SIDERITE = new IronIngotSiderite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronNuggetSiderite.");
        IRON_NUGGET_SIDERITE = new IronNuggetSiderite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronIngotPyrite.");
        IRON_INGOT_PYRITE = new IronIngotPyrite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronNuggetPyrite.");
        IRON_NUGGET_PYRITE = new IronNuggetPyrite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronIngotMagnetite.");
        IRON_INGOT_MAGNETITE = new IronIngotMagnetite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronNuggetMagnetite.");
        IRON_NUGGET_MAGNETITE = new IronNuggetMagnetite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronIngotHematite.");
        IRON_INGOT_HEMATITE = new IronIngotHematite();
        Log.logger(LogBase.LOGGER_LEVEL.ALL, "Instantiating IronNuggetHematite.");
        IRON_NUGGET_HEMATITE = new IronNuggetHematite();
        Log.logger(LogBase.LOGGER_LEVEL.DEBUG, "ItemLoader load finished.");
    }
}
